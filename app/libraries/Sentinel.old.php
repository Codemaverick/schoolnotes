...
class Sentinel{
	...
	public function getLoggedInUser(){
		...
		if($authCookie){
			...
			$user = $this->userContext->find($token);
			return $user;
		}else{
			return null;
		}
	...
	public static function getAuthenticatedUser(){
		...
		if($authCookie){
			...
			$user = $doctrine->em->getRepository('models\Security\MembershipUser')->find($token);
			return $user;
		}else{
			return null;
		}
	...
	public static function getUserInfo($username){
	 	...
	 	$doctrine = new Doctrine();
		$context = $doctrine->em->getRepository('models\Security\MembershipUser');
